...
const (
	...
	MsgTokenQuotaResetUnlimited  = "token.quota_reset_unlimited"
	MsgTokenQuotaResetRequired   = "token.quota_reset_required"
	MsgTokenQuotaResetExpired    = "token.quota_reset_expired"
